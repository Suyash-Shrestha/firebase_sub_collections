...
import 'package:firebase_sub_collections/pages/add_store_page.dart';
import 'package:firebase_sub_collections/pages/login_page.dart';
import 'package:firebase_sub_collections/pages/store_item_list_page.dart';
import 'package:firebase_sub_collections/provider/myprovider.dart';
import 'package:firebase_sub_collections/utils/constants.dart';
import 'package:firebase_sub_collections/view_models/add_store_view_model.dart';
import 'package:firebase_sub_collections/view_models/store_list_view_model.dart';
import 'package:firebase_sub_collections/view_models/store_view_model.dart';
import 'package:firebase_sub_collections/widgets/empty_results_widget.dart';
import 'package:firebase_sub_collections/widgets/recent_orders.dart';
...
class _StoreListPage extends State<StoreListPage> {
  ...
  void _navigateToStoreItems(BuildContext context, StoreViewModel store) {
    Navigator.push(
        context,
        MaterialPageRoute(
            builder: (context) => StoreItemListPage(store, store.storeId)));
  }
...
//----------------------------------------->> Building recent orders list <<-----------------------------------
                  ...
                  Expanded(
                    child: ListView.builder(
                      ...
                      itemBuilder: (ctx, index) => _buildSingleCategory(
                        ...
                        resturantName: myProvider
                            .getCategoryModelList[index].resturantName,
                        date: myProvider.getCategoryModelList[index].date,
                      ),
                    ),
                  ),
                ],
  ...
  Widget _buildSingleCategory(
      {String image, String name, String resturantName, String date}) {
    return Container(
